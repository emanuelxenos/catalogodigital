...
func main() {
	...
	r.Group(func(r chi.Router) {
		...
		r.Get("/master/lojas", h.HandleMasterShops)
		r.Get("/master/faturamento", h.HandleMasterBilling)
		r.Get("/master/faturamento/exportar", h.HandleMasterExportBillingCSV)
		r.Get("/master/faturamento/{id}/comprovante", h.HandleMasterPrintInvoiceReceipt)
		r.Get("/master/configuracoes", h.HandleMasterSettings)
		r.Post("/master/shops/{id}/toggle", h.HandleMasterToggleShop)
		r.Post("/master/shops/{id}/plan", h.HandleMasterChangePlan)
		r.Post("/master/plans/{id}", h.HandleMasterUpdatePlan)
