...
(2, 'Prata (Essencial)', 29.90, 20, 4, '{"coupons": true, "business_hours": false}'),
(3, 'Ouro (Profissional)', 49.90, 100, 10, '{"coupons": true, "business_hours": true}'),
...
-- Tabela para Banners Promocionais da Loja
